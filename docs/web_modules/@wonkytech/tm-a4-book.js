import { h as html$1 } from '../common/lit-html-9957b87e.js';
...
`,
  ...
  */
  _animateCSS: function () {
    ...
    if (this._dotStyles) {
      deep.querySelector(".slider__slides").style.transform = "translateX(-" + 100 * this.position + "%)", indSel.style.opacity = "1";
  ...
  */
  _countSlides: function () {
    ...
    this.totalSlides = this.$.aaa.assignedElements({
      flatten: true
    }).length;
  ...
  */
  attached: function () {
    var this$ = this;
    this.autoProgress == true ? setTimeout(function () {
      this$._autoProceed();
    }, 0) : false; // Strange hack, but it works.
